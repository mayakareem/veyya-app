        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <a
              ...
              className="h-11 w-11 sm:h-14 sm:w-14 inline-flex items-center justify-center rounded-md hover:bg-muted transition-colors"
            ...
            {/* LINE Contact */}
            <a
              href="https://line.me/R/ti/p/@XXXXXXXXX"
              target="_blank"
              rel="noopener noreferrer"
              className="h-11 w-11 sm:h-14 sm:w-14 inline-flex items-center justify-center rounded-md hover:bg-muted transition-colors"
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button variant="ghost" size="icon" className="h-11 w-11 sm:h-14 sm:w-14">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button variant="ghost" size="icon" className="h-11 w-11 sm:h-14 sm:w-14 relative">
                  <ShoppingCart className="w-6 h-6 sm:w-8 sm:h-8" />
                  {totalItems > 0 && (
                    <span className="absolute -top-1 -right-1 w-6 h-6 bg-primary text-primary-foreground rounded-full text-xs flex items-center justify-center font-semibold">
                      {totalItems}
                    </span>
                  )}
                </Button>
